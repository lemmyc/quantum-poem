'use client'; // Giữ nguyên 'use client' ở đây
...
// Đây là component chứa logic client của bạn
export default function FeatureClient() {
  ...
  // Không có lỗi mainError được định nghĩa, tạm thời comment lại hoặc thêm state cho nó
    ...
    async function fetchKeywords() {
      ...
      try {
        ...
        if (newSortedWords.length === 0) {
            ...
            console.error("Could not determine relevant keywords from the generated list. Please try again.");
            return;
        }
